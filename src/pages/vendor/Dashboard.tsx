...
import { AlertCircle, Clock, FileText, CheckCircle, Settings } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="flex flex-wrap gap-4">
          <Link
            to="/vendor/services"
            className="bg-[#0A66C2] hover:bg-[#004182] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors inline-flex items-center"
          >
